//TicTacToeCPUHard is the Unbeatable AI
...
public class TicTacToeCPUHard implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
			...
			{
				frame.dispose();
				TicTacToeCPUHard obj=new TicTacToeCPUHard();
			}
			...
			{
				if(choice.getSelectedItem()=="Medium")
				{
					frame.dispose();
					TicTacToeCPUMedium obj2=new TicTacToeCPUMedium();
				}
	...
	public int returnAIPosition()
	{
		...
		*/
		...
		if(changed==0)
		{
			...
			else if((buttons[1].getText())=="") //If between the corners position 1 is occupied check for 2nd corner
				return 1;
