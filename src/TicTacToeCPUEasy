...
public class TicTacToeCPUEasy implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
			...
			{
				frame.dispose();
				TicTacToeCPUEasy obj=new TicTacToeCPUEasy();
			}
			...
			else if(e.getSource()==choice)
			{
				...
				else if(choice.getSelectedItem()=="Hard")
				{
					frame.dispose();
					TicTacToeCPUHard obj3=new TicTacToeCPUHard();
				}
			}
	}
